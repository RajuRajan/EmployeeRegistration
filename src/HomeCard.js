...
class HomeCard extends React.Component{
    ...
    {       
        return(
            ...
            <div  id="rcorners2" style={{width: 200 ,textAlign: "center",backgroundColor:'#edd8f0'}} >
             <img id="rcorners1"  src={this.state.imgsrc} alt="img" width="150px" heigth="150px"/>
                        <div className="card-body">
                      
                        <p className="card-title" id="fontdesign3"style={{ textShadow: "2px #FF0000"}}>{this.state.name}</p>
                        EMPLOYEEID  <p className="card-text" id="fontdesign3" > {this.state.employeeId}</p>
                        DESIGNATION  <p className="card-text" id="fontdesign3"> {this.state.designation}</p>
      ...
      <div className="modal-content"> 
        ...
        <div className="box card-shadow">
                <div className='container-fluid'>
                    ...
                    <div className="row">
                    <div className="col-xs-4"><img   width="150px" height="150px" src={this.state.imgsrc} alt="emp img "></img></div>
                               ...
                               <div className="col-xs-8">
                                              ...
                                              <div className="row">
                                                  <div className="col-xs-12">
                                                        <p>Employee job descriptions identify and spell out the responsibilities of a specific job. They also include information about working conditions, tools, equipment used, knowledge and skills needed, and relationships with other positions including the immediate boss.</p>
                                                        </div>
                                                        </div> 
